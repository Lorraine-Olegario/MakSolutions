            ...
            <div class="row">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-4">
                            <div class="list-item-header">
                                <img src="<?=env('APP_URL')?>/img/estrela.jfif" class="img-fluid inline-img" alt="Equipamentos" title="Equipamentos">
                        ...
                        <li class="mb-4">
                            <div class="list-item-header">
                                <img src="<?=env('APP_URL')?>/img/estrela.jfif" class="img-fluid inline-img" alt="Impressão" title="Impressão">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 mb-6">
                    <ul class="list-unstyled">
                        <li class="mb-4">
                            <div class="list-item-header">
                                <img src="<?=env('APP_URL')?>/img/estrela.jfif" class="img-fluid inline-img" alt="Impressão Segura" title="Impressão Segura">
                        ...
                        <li class="mb-4">
                            <div class="list-item-header">
                                <img src="<?=env('APP_URL')?>/img/estrela.jfif" class="img-fluid inline-img" alt="Gestão Eficiente" title="Gestão Eficiente">
